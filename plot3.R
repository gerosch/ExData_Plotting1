...
## Script: plot3.R                                                           ##
## ---------------                                                           ##
## This is script 3 for the Course Project 1 in <Exploratory Data Analysis>. ##
...
## requested plot 3 as png file with 480x480 pixels in the local working     ##
## driectory with file name <plot3.png> as requested by the instructions.    ## 
###############################################################################
