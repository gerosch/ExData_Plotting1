...
## Script: plot2.R                                                           ##
## ---------------                                                           ##
## This is script 2 for the Course Project 1 in <Exploratory Data Analysis>. ##
...
## requested plot 2 as png file with 480x480 pixels in the local working     ##
## driectory with file name <plot2.png> as requested by the instructions.    ## 
###############################################################################
...
with(dat, plot(Date, Global_active_power, type="l",main="",xlab="",ylab="Global Active Power (kilowatts)"))
